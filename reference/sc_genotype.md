...
#> Writing configuration parameters to:  /tmp/RtmpM0tt18/filea7091a8c9095/config_file_42761.json 
...
#> ── Running step: barcode_demultiplex @ Fri Oct 31 05:41:30 2025 ────────────────
...
#> UMI: NNNNNNNNNNNN
#> polyT: TTTTTTTTT
#> Setting known barcodes from /tmp/RtmpM0tt18/filea7091a8c9095/bc_allow.tsv
...
#> ── Running step: genome_alignment @ Fri Oct 31 05:41:31 2025 ───────────────────
#> Creating junction bed file from GFF3 annotation.
#> Aligning sample /tmp/RtmpM0tt18/filea7091a8c9095/matched_reads.fastq.gz -> /tmp/RtmpM0tt18/filea7091a8c9095/align2genome.bam
...
#> sc_mtt+   indel = FALSE
#> sc_mtt+ )
#> 05:41:31 Got 1 bam file, parallelizing over each position ...
#>   |                                                                              |                                                                      |   0%  |                                                                              |===================================                                   |  50%  |                                                                              |======================================================================| 100%
#> 
#> 05:41:32 Merging results ...
#> 
#> sc_mtt> head(snps_tb)
#> # A tibble: 6 × 7
