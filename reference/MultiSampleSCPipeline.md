...
#> Writing configuration parameters to:  /tmp/RtmpaNKtnp/file80d0174f3545/config_file_32976.json 
#> Configured steps: 
...
ppl <- run_FLAMES(ppl)
#> ── Running step: barcode_demultiplex @ Fri Oct 31 06:42:56 2025 ────────────────
...
#> UMI: NNNNNNNNNNNN
#> polyT: TTTTTTTTT
#> Setting known barcodes from /tmp/RtmpaNKtnp/file80d0174f3545/bc_allow.tsv
#> Number of known barcodes: 143
#> Processing file: /tmp/RtmpaNKtnp/file80d0174f3545/fastq/sample1.fq.gz
#> Searching for barcodes...
#> Processing file: /tmp/RtmpaNKtnp/file80d0174f3545/fastq/sample2.fq.gz
#> Searching for barcodes...
#> Processing file: /tmp/RtmpaNKtnp/file80d0174f3545/fastq/sample3.fq.gz
#> Searching for barcodes...
...
#> 2    27
#> 1    53
#> ── Running step: genome_alignment @ Fri Oct 31 06:42:57 2025 ───────────────────
#> Creating junction bed file from GFF3 annotation.
#> Aligning sample /tmp/RtmpaNKtnp/file80d0174f3545/sampleA_matched_reads.fastq.gz -> /tmp/RtmpaNKtnp/file80d0174f3545/sampleA_align2genome.bam
#> Warning: samtools not found, using Rsamtools instead, this could be slower and might fail for large BAM files.
#> Sorting BAM files by genome coordinates with 1 threads...
#> Indexing bam files
#> Aligning sample /tmp/RtmpaNKtnp/file80d0174f3545/sample1_matched_reads.fastq.gz -> /tmp/RtmpaNKtnp/file80d0174f3545/sample1_align2genome.bam
#> Warning: samtools not found, using Rsamtools instead, this could be slower and might fail for large BAM files.
#> Sorting BAM files by genome coordinates with 1 threads...
#> Indexing bam files
#> Aligning sample /tmp/RtmpaNKtnp/file80d0174f3545/sample2_matched_reads.fastq.gz -> /tmp/RtmpaNKtnp/file80d0174f3545/sample2_align2genome.bam
#> Warning: samtools not found, using Rsamtools instead, this could be slower and might fail for large BAM files.
#> Sorting BAM files by genome coordinates with 1 threads...
#> Indexing bam files
#> Aligning sample /tmp/RtmpaNKtnp/file80d0174f3545/sample3_matched_reads.fastq.gz -> /tmp/RtmpaNKtnp/file80d0174f3545/sample3_align2genome.bam
#> Warning: samtools not found, using Rsamtools instead, this could be slower and might fail for large BAM files.
#> Sorting BAM files by genome coordinates with 1 threads...
#> Indexing bam files
#> ── Running step: gene_quantification @ Fri Oct 31 06:42:58 2025 ────────────────
#> 06:42:58 AM Fri Oct 31 2025 quantify genes 
#> Using BAM(s): /tmp/RtmpaNKtnp/file80d0174f3545/sampleA_align2genome.bam,
#> /tmp/RtmpaNKtnp/file80d0174f3545/sample1_align2genome.bam,
#> /tmp/RtmpaNKtnp/file80d0174f3545/sample2_align2genome.bam, and
#> /tmp/RtmpaNKtnp/file80d0174f3545/sample3_align2genome.bam
#> ── Running step: isoform_identification @ Fri Oct 31 06:42:59 2025 ─────────────
#> ── Running step: read_realignment @ Fri Oct 31 06:42:59 2025 ───────────────────
#> Checking for fastq file(s) /tmp/RtmpaNKtnp/file80d0174f3545/fastq, /tmp/RtmpaNKtnp/file80d0174f3545/fastq/sample1.fq.gz, /tmp/RtmpaNKtnp/file80d0174f3545/fastq/sample2.fq.gz, /tmp/RtmpaNKtnp/file80d0174f3545/fastq/sample3.fq.gz
#>  files found
#> Checking for fastq file(s) /tmp/RtmpaNKtnp/file80d0174f3545/sampleA_matched_reads.fastq.gz, /tmp/RtmpaNKtnp/file80d0174f3545/sample1_matched_reads.fastq.gz, /tmp/RtmpaNKtnp/file80d0174f3545/sample2_matched_reads.fastq.gz, /tmp/RtmpaNKtnp/file80d0174f3545/sample3_matched_reads.fastq.gz
#>  files found
#> Checking for fastq file(s) /tmp/RtmpaNKtnp/file80d0174f3545/sampleA_matched_reads_dedup.fastq.gz, /tmp/RtmpaNKtnp/file80d0174f3545/sample1_matched_reads_dedup.fastq.gz, /tmp/RtmpaNKtnp/file80d0174f3545/sample2_matched_reads_dedup.fastq.gz, /tmp/RtmpaNKtnp/file80d0174f3545/sample3_matched_reads_dedup.fastq.gz
#>  files found
#> Realigning sample /tmp/RtmpaNKtnp/file80d0174f3545/sampleA_matched_reads_dedup.fastq.gz -> /tmp/RtmpaNKtnp/file80d0174f3545/sampleA_realign2transcript.bam
#> Warning: samtools not found, using Rsamtools instead, this could be slower and might fail for large BAM files.
#> Sorting BAM files by 1 with CB threads...
#> Realigning sample /tmp/RtmpaNKtnp/file80d0174f3545/sample1_matched_reads_dedup.fastq.gz -> /tmp/RtmpaNKtnp/file80d0174f3545/sample1_realign2transcript.bam
#> Warning: samtools not found, using Rsamtools instead, this could be slower and might fail for large BAM files.
#> Sorting BAM files by 1 with CB threads...
#> Realigning sample /tmp/RtmpaNKtnp/file80d0174f3545/sample2_matched_reads_dedup.fastq.gz -> /tmp/RtmpaNKtnp/file80d0174f3545/sample2_realign2transcript.bam
#> Warning: samtools not found, using Rsamtools instead, this could be slower and might fail for large BAM files.
#> Sorting BAM files by 1 with CB threads...
#> Realigning sample /tmp/RtmpaNKtnp/file80d0174f3545/sample3_matched_reads_dedup.fastq.gz -> /tmp/RtmpaNKtnp/file80d0174f3545/sample3_realign2transcript.bam
#> Warning: samtools not found, using Rsamtools instead, this could be slower and might fail for large BAM files.
#> Sorting BAM files by 1 with CB threads...
#> ── Running step: transcript_quantification @ Fri Oct 31 06:43:00 2025 ──────────
experiment(ppl)
#> $sampleA
