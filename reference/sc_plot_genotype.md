...
ppl <- example_pipeline("SingleCellPipeline") |>
  run_FLAMES()
#> Writing configuration parameters to:  /tmp/RtmpmJ8vO7/file80d053bb9efe/config_file_32976.json 
...
#> ── Running step: barcode_demultiplex @ Fri Oct 31 06:52:46 2025 ────────────────
...
#> UMI: NNNNNNNNNNNN
#> polyT: TTTTTTTTT
#> Setting known barcodes from /tmp/RtmpmJ8vO7/file80d053bb9efe/bc_allow.tsv
...
#> 2    29
#> 1    57
#> ── Running step: genome_alignment @ Fri Oct 31 06:52:46 2025 ───────────────────
#> Creating junction bed file from GFF3 annotation.
#> Aligning sample /tmp/RtmpmJ8vO7/file80d053bb9efe/matched_reads.fastq.gz -> /tmp/RtmpmJ8vO7/file80d053bb9efe/align2genome.bam
#> Warning: samtools not found, using Rsamtools instead, this could be slower and might fail for large BAM files.
#> Sorting BAM files by genome coordinates with 8 threads...
#> Indexing bam files
#> ── Running step: isoform_identification @ Fri Oct 31 06:52:47 2025 ─────────────
#> ── Running step: read_realignment @ Fri Oct 31 06:52:47 2025 ───────────────────
#> Checking for fastq file(s) /__w/_temp/Library/FLAMES/extdata/fastq/musc_rps24.fastq.gz
#>  files found
#> Checking for fastq file(s) /tmp/RtmpmJ8vO7/file80d053bb9efe/matched_reads.fastq.gz
#>  files found
#> Checking for fastq file(s) /tmp/RtmpmJ8vO7/file80d053bb9efe/matched_reads_dedup.fastq.gz
#>  files not found
#> Warning: Oarfish does not support UMI deduplication, you should deduplicate reads before running Oarfish
#> Realigning sample /tmp/RtmpmJ8vO7/file80d053bb9efe/matched_reads.fastq.gz -> /tmp/RtmpmJ8vO7/file80d053bb9efe/realign2transcript.bam
#> Warning: samtools not found, using Rsamtools instead, this could be slower and might fail for large BAM files.
#> Sorting BAM files by 8 with CB threads...
#> ── Running step: transcript_quantification @ Fri Oct 31 06:52:47 2025 ──────────
sce <- experiment(ppl) |>
...
#> 06:52:52 Got 1 bam file, parallelizing over each position ...
#>   |                                                                              |                                                                      |   0%  |                                                                              |======================================================================| 100%
#> 
#> 06:52:53 Merging results ...
