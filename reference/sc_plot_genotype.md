...
ppl <- example_pipeline("SingleCellPipeline") |>
  run_FLAMES()
#> Writing configuration parameters to:  /tmp/RtmpM0tt18/filea7091e69ddb0/config_file_42761.json 
...
#> ── Running step: barcode_demultiplex @ Fri Oct 31 05:41:44 2025 ────────────────
...
#> UMI: NNNNNNNNNNNN
#> polyT: TTTTTTTTT
#> Setting known barcodes from /tmp/RtmpM0tt18/filea7091e69ddb0/bc_allow.tsv
...
#> 2    29
#> 1    57
#> ── Running step: genome_alignment @ Fri Oct 31 05:41:44 2025 ───────────────────
#> Creating junction bed file from GFF3 annotation.
#> Aligning sample /tmp/RtmpM0tt18/filea7091e69ddb0/matched_reads.fastq.gz -> /tmp/RtmpM0tt18/filea7091e69ddb0/align2genome.bam
#> Warning: samtools not found, using Rsamtools instead, this could be slower and might fail for large BAM files.
#> Sorting BAM files by genome coordinates with 8 threads...
#> Indexing bam files
#> ── Running step: isoform_identification @ Fri Oct 31 05:41:44 2025 ─────────────
#> ── Running step: read_realignment @ Fri Oct 31 05:41:44 2025 ───────────────────
#> Checking for fastq file(s) /__w/_temp/Library/FLAMES/extdata/fastq/musc_rps24.fastq.gz
#>  files found
#> Checking for fastq file(s) /tmp/RtmpM0tt18/filea7091e69ddb0/matched_reads.fastq.gz
#>  files found
#> Checking for fastq file(s) /tmp/RtmpM0tt18/filea7091e69ddb0/matched_reads_dedup.fastq.gz
#>  files not found
#> Warning: Oarfish does not support UMI deduplication, you should deduplicate reads before running Oarfish
#> Realigning sample /tmp/RtmpM0tt18/filea7091e69ddb0/matched_reads.fastq.gz -> /tmp/RtmpM0tt18/filea7091e69ddb0/realign2transcript.bam
#> Warning: samtools not found, using Rsamtools instead, this could be slower and might fail for large BAM files.
#> Sorting BAM files by 8 with CB threads...
#> ── Running step: transcript_quantification @ Fri Oct 31 05:41:45 2025 ──────────
sce <- experiment(ppl) |>
...
#> 05:41:50 Got 1 bam file, parallelizing over each position ...
#>   |                                                                              |                                                                      |   0%  |                                                                              |======================================================================| 100%
#> 
#> 05:41:51 Merging results ...
