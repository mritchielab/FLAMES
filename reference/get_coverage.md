...
#> ℹ Writing configuration to: /tmp/Rtmp4nGYdi/filebc4441071c06/config_file_48196.json
#> Configured steps: 
...
#> ── Running step: read_realignment @ Fri Jun 26 08:24:47 2026 ───────────────────
#> Using reference annotation for transcriptome assembly.
#> Realigning sample sample1 -> /tmp/Rtmp4nGYdi/filebc4441071c06/sample1_realign2transcript.bam
#> Warning: samtools not found, using Rsamtools instead, this could be slower and might fail for large BAM files.
#> Skipped sorting BAM files.
#> Realigning sample sample2 -> /tmp/Rtmp4nGYdi/filebc4441071c06/sample2_realign2transcript.bam
#> Warning: samtools not found, using Rsamtools instead, this could be slower and might fail for large BAM files.
#> Skipped sorting BAM files.
#> Realigning sample sample3 -> /tmp/Rtmp4nGYdi/filebc4441071c06/sample3_realign2transcript.bam
#> Warning: samtools not found, using Rsamtools instead, this could be slower and might fail for large BAM files.
#> Skipped sorting BAM files.
...
#> 1 ENSMUST0000…      0.462      0.915      0.965      0.980      0.980      0.980
#> 2 ENSMUST0000…      0.7        0.85       0.95       0.95       0.95       0.95 
