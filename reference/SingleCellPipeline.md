...
#> Writing configuration parameters to:  /tmp/RtmpjRxi1E/file95d256fafc56/config_file_38354.json 
...
ppl <- run_FLAMES(ppl)
#> ── Running step: barcode_demultiplex @ Thu Feb 19 01:55:21 2026 ────────────────
#> Using flexiplex for barcode demultiplexing.
#> Loading known barcodes from /tmp/RtmpjRxi1E/file95d256fafc56/bc_allow.tsv
...
#> 2    29
#> 1    57
#> ── Running step: genome_alignment @ Thu Feb 19 01:55:21 2026 ───────────────────
#> Creating junction bed file from GFF3 annotation.
#> Aligning sample /tmp/RtmpjRxi1E/file95d256fafc56/matched_reads.fastq.gz -> /tmp/RtmpjRxi1E/file95d256fafc56/align2genome.bam
#> Warning: samtools not found, using Rsamtools instead, this could be slower and might fail for large BAM files.
#> Sorting BAM files by genome coordinates with 8 threads...
#> Indexing bam files
#> ── Running step: isoform_identification @ Thu Feb 19 01:55:21 2026 ─────────────
#> ── Running step: read_realignment @ Thu Feb 19 01:55:21 2026 ───────────────────
#> Checking for fastq file(s) /__w/_temp/Library/FLAMES/extdata/fastq/musc_rps24.fastq.gz
#>  files found
#> Checking for fastq file(s) /tmp/RtmpjRxi1E/file95d256fafc56/matched_reads.fastq.gz
#>  files found
#> Checking for fastq file(s) /tmp/RtmpjRxi1E/file95d256fafc56/matched_reads_dedup.fastq.gz
#>  files not found
#> Warning: Oarfish does not support UMI deduplication, you should deduplicate reads before running Oarfish
#> Realigning sample /tmp/RtmpjRxi1E/file95d256fafc56/matched_reads.fastq.gz -> /tmp/RtmpjRxi1E/file95d256fafc56/realign2transcript.bam
#> Warning: samtools not found, using Rsamtools instead, this could be slower and might fail for large BAM files.
#> Sorting BAM files by 8 with CB threads...
#> ── Running step: transcript_quantification @ Thu Feb 19 01:55:22 2026 ──────────
experiment(ppl)
