...
#> Writing configuration parameters to:  /tmp/RtmpaNKtnp/file80d0720a28a3/config_file_32976.json 
#> Configured steps: 
...
#> ── Running step: barcode_demultiplex @ Fri Oct 31 06:44:31 2025 ────────────────
...
#> UMI: NNNNNNNNNNNN
#> polyT: TTTTTTTTT
#> Setting known barcodes from /tmp/RtmpaNKtnp/file80d0720a28a3/bc_allow.tsv
...
#> 2    29
#> 1    57
#> ── Running step: genome_alignment @ Fri Oct 31 06:44:32 2025 ───────────────────
#> Creating junction bed file from GFF3 annotation.
#> Aligning sample /tmp/RtmpaNKtnp/file80d0720a28a3/matched_reads.fastq.gz -> /tmp/RtmpaNKtnp/file80d0720a28a3/align2genome.bam
#> Warning: samtools not found, using Rsamtools instead, this could be slower and might fail for large BAM files.
#> Sorting BAM files by genome coordinates with 8 threads...
#> Indexing bam files
#> ── Running step: gene_quantification @ Fri Oct 31 06:44:32 2025 ────────────────
#> 06:44:32 AM Fri Oct 31 2025 quantify genes 
#> Using BAM(s): /tmp/RtmpaNKtnp/file80d0720a28a3/align2genome.bam
#> ── Running step: isoform_identification @ Fri Oct 31 06:44:32 2025 ─────────────
#> ── Running step: read_realignment @ Fri Oct 31 06:44:32 2025 ───────────────────
#> Checking for fastq file(s) /__w/_temp/Library/FLAMES/extdata/fastq/musc_rps24.fastq.gz
#>  files found
#> Checking for fastq file(s) /tmp/RtmpaNKtnp/file80d0720a28a3/matched_reads.fastq.gz
#>  files found
#> Checking for fastq file(s) /tmp/RtmpaNKtnp/file80d0720a28a3/matched_reads_dedup.fastq.gz
#>  files found
#> Realigning sample /tmp/RtmpaNKtnp/file80d0720a28a3/matched_reads_dedup.fastq.gz -> /tmp/RtmpaNKtnp/file80d0720a28a3/realign2transcript.bam
#> Warning: samtools not found, using Rsamtools instead, this could be slower and might fail for large BAM files.
#> Sorting BAM files by 8 with CB threads...
#> ── Running step: transcript_quantification @ Fri Oct 31 06:44:33 2025 ──────────
#> Pipeline saved to /tmp/RtmpaNKtnp/file80d0720a28a3/pipeline.rds
```
