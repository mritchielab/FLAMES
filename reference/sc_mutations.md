...
#> ℹ Writing configuration to: /tmp/RtmpgehRKJ/filebbc018d3190b/config_file_48064.json
#> Configured steps: 
...
#> ── Running step: barcode_demultiplex @ Thu Aug 13 10:11:07 2026 ────────────────
#> Using flexiplex for barcode demultiplexing.
#> Loading known barcodes from /tmp/RtmpgehRKJ/filebbc018d3190b/bc_allow.tsv
...
#> ── Running step: genome_alignment @ Thu Aug 13 10:11:07 2026 ───────────────────
#> Creating junction bed file from GFF3 annotation.
#> Aligning sample /tmp/RtmpgehRKJ/filebbc018d3190b/matched_reads.fastq.gz -> /tmp/RtmpgehRKJ/filebbc018d3190b/align2genome.bam
...
#> 10:11:07 Got 1 bam file, parallelizing over each position ...
#>   |                                                                              |                                                                      |   0%  |                                                                              |===================================                                   |  50%  |                                                                              |======================================================================| 100%
#> 
#> 10:11:09 Merging results ...
head(snps_tb)
#> # A tibble: 6 × 7
