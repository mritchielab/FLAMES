...
verify_json_config(Json::Value json)
{
  ...
  if (!(json["isoform_parameters"]["MAX_DIST"] > 0 &&
        ...
        json["isoform_parameters"]["Min_sup_pct"] > 0 && 
        json["isoform_parameters"]["Min_sup_pct"] < 1 &&
...
load_json_config(Json::Value json)
{
    ...
    */
    ...
    config.pipeline_parameters.do_read_realignment = json["pipeline_parameters"]["do_read_alignment"].asBool();
