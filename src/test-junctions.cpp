...
// 			s6 = chr_to_blocks["SIRV6"][0];
// 		// test the contents of transcript_list
// 		Rcpp::Rcout << (compare_vector(s5.transcript_list, std::vector<std::string> {"SIRV508", "SIRV509", "SIRV502", "SIRV503", "SIRV501", "SIRV506", "SIRV507", "SIRV504", "SIRV505", "SIRV512", "SIRV510"}));
// 		Rcpp::Rcout << (compare_vector(s3.transcript_list, std::vector<std::string> {"SIRV310", "SIRV311", "SIRV308", "SIRV309", "SIRV304", "SIRV305", "SIRV306", "SIRV307", "SIRV301", "SIRV302", "SIRV303"}));
// 		Rcpp::Rcout << (compare_vector(s6.transcript_list, std::vector<std::string> {"SIRV618", "SIRV617", "SIRV601", "SIRV616", "SIRV603", "SIRV602", "SIRV605", "SIRV604", "SIRV607", "SIRV606", "SIRV609", "SIRV608", "SIRV614", "SIRV615", "SIRV612", "SIRV613", "SIRV610", "SIRV611"}));

// 		// test the contents of gene_to_transcript
// 		Rcpp::Rcout << (compare_map(s5.gene_to_transcript, { {"SIRV5", {"SIRV508", "SIRV509", "SIRV502", "SIRV503", "SIRV501", "SIRV506", "SIRV507", "SIRV504", "SIRV505", "SIRV512", "SIRV510"}} } ));
// 		Rcpp::Rcout << (compare_map(s3.gene_to_transcript, { {"SIRV3", {"SIRV310", "SIRV311", "SIRV308", "SIRV309", "SIRV304", "SIRV305", "SIRV306", "SIRV307", "SIRV301", "SIRV302", "SIRV303"}} } ));
// 		Rcpp::Rcout << (compare_map(s6.gene_to_transcript, { {"SIRV6", {"SIRV618", "SIRV617", "SIRV601", "SIRV616", "SIRV603", "SIRV602", "SIRV605", "SIRV604", "SIRV607", "SIRV606", "SIRV609", "SIRV608", "SIRV614", "SIRV615", "SIRV612", "SIRV613", "SIRV610", "SIRV611"}} }));

// 		// test the start and end positions
// 		Rcpp::Rcout << (s5.start == 1000);
// 		Rcpp::Rcout << (s5.end == 13606);
// 		Rcpp::Rcout << (s3.start == 1000);
// 		Rcpp::Rcout << (s3.end == 9943);
// 		Rcpp::Rcout << (s6.start == 1000);
// 		Rcpp::Rcout << (s6.end == 11837);
