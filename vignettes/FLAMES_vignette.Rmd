...
if (is.character(locate_minimap2_dir())) { # do not run if minimap2 cannot be found
  sce <- sc_long_pipeline(annotation = annot, fastq = fastq, genome_fa = genome_fa, outdir = outdir, config_file = config_file, match_barcode = FALSE)
}
```
...
## FLAMES on Windows
VDue to FLAMES requiring minimap2 and pysam, FLAMES is currently unavaliable on Windows.
