...
unfiltered <- combine_sce(short_read_large = scm_lib80,
                          short_read_small = scm_lib20,
...
plots <- sc_annotate_plots(gene = "ENSG00000108107",
                           sce_all = scuttle::quickPerCellQC(combined_sce))
scater::plotReducedDim(plots[["sce_all"]],
                       dimred = "PCA",
                       colour_by = "Lib_small")
plots[["plot_umap"]]
